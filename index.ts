...
createServer((req, res) => {
    ...
    if (filePath && file_cache[filePath]) {
        ...
        let vue_route = filePath?.match(/^([a-z]{2})?(\/)?(contact|api|docs|pricing|free-encrypted-chat|privacy|privacy-policy|terms|terms-of-service|index|terms-of-use|faq|account|custom)?(\.html)?\/?$/);
